    ...
    <section id="process" className="py-24 relative">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            Our 6-Step <span className="text-cyan text-glow">Zen Process</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 rounded-2xl glass flex items-center justify-center text-cyan mb-6 relative group-hover:scale-110 transition-transform duration-300 group-hover:box-glow group-hover:border-cyan/50 bg-navy">
                    {step.icon}
                    <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-cyan text-navy text-xs font-bold flex items-center justify-center">
                      {index + 1}
                    </div>
                  </div>
                  <h3 className="text-lg font-bold mb-3 font-heading">{step.title}</h3>
