...
`;
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-cyan/5 rounded-full blur-[120px] -z-10"></div>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <span className="text-cyan text-glow">Extraordinary Together?</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="glass p-8 rounded-3xl border border-white/10 h-full">
              ...
              <div className="mt-12 pt-8 border-t border-white/10">
                <a href="https://wa.me/+8801862059959" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-4 bg-[#25D366]/10 text-[#25D366] rounded-xl hover:bg-[#25D366] hover:text-white transition-all duration-300 font-medium">
          ...
          >
            <form className="glass p-8 md:p-10 rounded-3xl border border-white/10" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input 
                    ...
                    required
                    className="w-full bg-navy border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-cyan/50 transition-colors"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={handleChange}
                    className="w-full bg-navy border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-cyan/50 transition-colors appearance-none"
                  >
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-400 mb-2">Approximate Budget</label>
                <select 
                  name="budget"
              ...
              <div className="mb-8">
                ...
                <textarea 
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-navy border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-cyan/50 transition-colors resize-none"
              ...
              <button 
                ...
                className="w-full py-4 bg-cyan text-navy font-bold rounded-xl hover:bg-white transition-all duration-300 box-glow hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
