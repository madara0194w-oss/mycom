    ...
    <section id="services" className="py-24 relative">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Our Expert <span className="text-cyan text-glow">Services</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 rounded-xl bg-navy flex items-center justify-center text-cyan mb-6 group-hover:scale-110 transition-transform duration-300 border border-white/5 group-hover:border-cyan/30 group-hover:box-glow">
                  {service.icon}
                </div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mt-24 relative rounded-3xl overflow-hidden h-[400px] glass border border-white/10"
        >
          <img 
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-navy via-navy/80 to-transparent flex items-center">
            <div className="p-10 max-w-xl">
              <h3 className="text-3xl font-bold mb-4">Built for Performance</h3>
