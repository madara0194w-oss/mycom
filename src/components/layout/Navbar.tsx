    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:block">
          <a
            href="#contact"
            className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-navy bg-cyan rounded-full hover:bg-white transition-all duration-300 box-glow hover:scale-105"
          >
            Get Free Quote
          </a>
        </div>
        ...
        >
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
              className="text-base font-medium text-gray-300 hover:text-cyan transition-colors"
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center px-6 py-3 mt-2 text-sm font-medium text-navy bg-cyan rounded-full hover:bg-white transition-all duration-300 box-glow"
            onClick={() => setIsMobileMenuOpen(false)}
          >
            Get Free Quote
          </a>
